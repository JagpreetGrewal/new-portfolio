...
function Experience() {
  ...
  const experienceItems = [
    ...
    },    
    {
      ...
      descriptions: ['Reduced installation time by 20% by implementing Batch scripts that automatically queried and saved hardware information to an online database',
      ],
  ...
  const projectItems = [
    ...
    },
    {
      ...
      descriptions: ['Tested pathloss rapidly across 2.4 GHz and 5 GHz frequencies in lab machines by developing a Python application that integrated SCPI commands to communicate with the hardware', 
        'Enhanced data accuracy by 70% by analyzing sensor data with NumPy', 
